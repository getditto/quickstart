...
int main() {
  try {
    ...
    auto peer = unique_ptr<TasksPeer>(
        new TasksPeer(DITTO_APP_ID, DITTO_PLAYGROUND_TOKEN, DITTO_AUTH_URL,
    ...
    if (found) {
      cout << "PASS: GitHub Actions → Ditto Cloud → C++ SDK sync verified in "
