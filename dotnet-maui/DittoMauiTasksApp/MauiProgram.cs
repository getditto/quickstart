...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var developmentToken = envVars.GetValueOrDefault("DITTO_DEVELOPMENT_TOKEN", "");
        var serverUrl = envVars.GetValueOrDefault("DITTO_SERVER_URL", "");
        ...
        var dittoManager = DittoManager
            .Create(databaseId, developmentToken, serverUrl, offlineLicenseToken)
            .GetAwaiter()
            .GetResult();
