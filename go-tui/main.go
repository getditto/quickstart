...
func main() {
	...
	if databaseId == "" || token == "" || serverURL == "" {
		log.Fatal("Missing required environment variables. Please set DITTO_DATABASE_ID, DITTO_DEVELOPMENT_TOKEN, and DITTO_SERVER_URL")
	}
	...
	manager, err := NewDittoManager(databaseId, token, serverURL)
	if err != nil {
