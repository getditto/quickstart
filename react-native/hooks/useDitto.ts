...
import { DITTO_DATABASE_ID, DITTO_DEVELOPMENT_TOKEN, DITTO_SERVER_URL } from '@env';
 ...
 * instance lifecycle (open, auth, sync.start). Returns the ready `ditto`
